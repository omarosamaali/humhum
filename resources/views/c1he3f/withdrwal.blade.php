    ...
    <div class="page-wrapper">
        ...
        <header class="header header-fixed border-bottom">
            <div class="header-content">
                ...
                <div class="mid-content">
                    <h4 class="title">طلب سحب أرباح</h4>
                </div>
        ...
        <main class="page-content space-top p-b100" style="text-align: center;">
            <div class="container">
                    ...
                    <div class="item-head">
                        <div class="dz-meta">
                            <ul style="display: flex; align-items: center; justify-content: center;">
                                <h6 class="dz-title my-2" style="color: #e00000;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="rotate: 180deg; 
                                        position: relative; top: -1px; right: -7px;" viewBox="0 0 24 24" fill="none">
                                        <path d="M8 7V17H12C14.8 17 17 14.8 17 12C17 9.2 14.8 7 12 7H8Z"
                                            stroke="#e00000" stroke-width="1.5" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M6.5 11H18.5" stroke="#e00000" stroke-width="1.5"
                                            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M6.5 13H12.5H18.5" stroke="#e00000" stroke-width="1.5"
                                            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                    تستطيع سحب 100
                                </h6>
                ...
                <div class="my-3">
                    <input type="text" id="city" value="{{ auth()->user()->name }}" disabled class="form-control"
                        style="text-align: center;">
                </div>

                <div class="mb-3">
                    <input type="number" id="location" class="form-control" placeholder="مبلغ الأرباح بالدرهم"
                        style="text-align: center;">
                </div>
            </div>
        </main>
        ...
        <div class="footer-fixed-btn bottom-0 bg-white">
            <a href="delivery-address.html" class="btn btn-lg btn-thin btn-primary w-100 rounded-xl">إرسال الطلب</a>
        </div>
        <!-- Footer Fixed Button -->
    </div>
