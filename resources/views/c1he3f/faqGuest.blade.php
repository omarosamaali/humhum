                ...
                <div class="container">
                    ...
                    <div class="accordion dz-accordion style-2" id="faqAccordionParent"> {{-- Give a common ID to the parent accordion container --}}
                        <div class="accordion-item">
                            ...
                            <div id="collapse{{ $faq->id }}" {{-- Unique ID for the collapsible content --}} class="accordion-collapse collapse" {{-- Add 'collapse' initially --}} aria-labelledby="heading{{ $faq->id }}" {{-- Reference the header's unique ID --}} data-bs-parent="#faqAccordionParent"> {{-- Reference the common parent accordion container ID --}}
