                    ...
                    <div thumbsSlider="" class="swiper mySwiper dz-tabs-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <h5 class="title">تحديات الطهاه</h5>
                            </div>
                            <div class="swiper-slide">
                                <h5 class="title">تحديات المتسخدمين</h5>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <li>
                                        <div class="dz-card list">
                                            <div class="dz-media">
                                                ...
                                                @if($isVideo)
                                                <video controls style="    height: 186px;
    object-fit: contain;
    border-radius: 20px; max-width: 100%; max-height: 100%; object-fit: contain;">
                                    ...
                                    @endforeach
                                    @if ($challenges->where('status', 'active')->isEmpty())
                                    <li>
                            ...
                            <div class="swiper-slide">
                                <ul class="featured-list">
                                    @foreach ($challenges->where('status', 'inactive') as $challenge)
