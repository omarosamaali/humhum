...
<body style="direction: rtl;">
    <div class="page-wrapper">
        ...
        <main class="page-content space-top">
                    ...
                    <div thumbsSlider="" class="swiper mySwiper dz-tabs-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <h5 class="title">منتج</h5>
                            </div>
                            <div class="swiper-slide">
                                <h5 class="title">منتج رقمي</h5>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <ul class="featured-list">
                                    @foreach ($products->where('type', 'physical') as $product)
                                    <li>
                                        <div class="dz-card list">
                                            <div class="dz-media">
                                                <a href="{{ route('c1he3f.products.show', $product->id) }}">
                                                    <img style="height: 175px;" src="{{ asset('storage/' . $product->image_path) }}" alt="{{ $product->name }}">
                                                </a>
                                                <div class="dz-rating" style="background-color: var(--primary);">
                                                    <i class="fa fa-coins"></i> {{ $product->price }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="dz-content">
                                                <div class="dz-head">
                                                    <h6 class="title">
                                                        <a href="{{ route('c1he3f.products.show', $product->id) }}">{{ $product->name }}</a>
                                                        <div style="font-size: 12px; color: gray;">{{ $product->description }}</div>
                                                ...
                                                <ul class="dz-meta">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('c1he3f.products.edit-product', $product->id) }}" class="btn rounded-xl dz-buy-btn">
                                                            <i class="fa-regular fa-pen-to-square"></i>
                                                        </a>
                                                        <form action="{{ route('c1he3f.products.destroy', $product->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button style="padding: 11px;" type="submit" class="btn btn-danger rounded-xl" onclick="return confirm('هل أنت متأكد من حذف هذا المنتج؟')">
                            ...
                            <div class="swiper-slide">
                                <ul class="featured-list">
                                    @foreach ($products->where('type', 'digital') as $product)
                                    <li>
                                        <div class="dz-card list">
                                            <div class="dz-media">
                                                <a href="{{ route('c1he3f.products.show', $product->id) }}">
            ...
            <a href="{{ route('c1he3f.products.create') }}" class="plus-btn">
