    ...
    <div class="page-wrapper">
        ...
        <div class="dz-nav-floting">
            ...
            <main class="page-content space-top" style="direction: rtl;">
                <h2 id="coming-soon">قريبا</h2>
                <div class="container" style="display: flex ; align-items: center; justify-content: center; margin: auto; ">
                    <img src="{{ asset('assets/images/comes.svg') }}" style=" width: 313px; display: flex ; margin: auto; position: absolute; bottom: 50px; align-items: center; justify-content: center;width: 313px; display: flex ; margin: auto; position: absolute; bottom: 50px; align-items: center; justify-content: center;" alt="">
