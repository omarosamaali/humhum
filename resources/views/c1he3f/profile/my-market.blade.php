            ...
            <div class="container py-0">
                <div class="dz-authentication-area">
                    ...
                    <form action="{{ route('c1he3f.profile.save-market-choice') }}" method="POST" id="marketChoiceForm">
                        ...
                        <ul class="dz-list-group radio style-2" style="direction: rtl;">
                            <li class="list-group-items" style="margin-bottom: 20px; border-radius: 5px; border: 1px solid #e00000; padding: 12px;">
                                <label class="radio-label">
                                    <input type="radio" name="has_market" value="1" 
                                        {{ old('has_market', $chefHasMarket ?? 0) == 1 ? 'checked' : '' }}>
                                    <div class="checkmark">
                            ...
                            <li class="list-group-items" style="margin-bottom: 20px; border-radius: 5px; border: 1px solid #e00000; padding: 12px;">
                                <label class="radio-label">
                                    <input type="radio" name="has_market" value="0" 
                                        {{ old('has_market', $chefHasMarket ?? 0) == 0 ? 'checked' : '' }}>
                                    <div class="checkmark">
                                        <div class="list-content">
                        ...
                        <div class="footer-fixed-btn bottom-0 bg-white" id="deliveryLocationButton" 
                             style="bottom: 25%; position: relative; 
                             {{ old('has_market', $chefHasMarket ?? 0) == 0 ? 'display: none;' : '' }}">
                            <button type="submit" 
                               class="btn btn-lg btn-thin btn-primary w-100 rounded-xl">أماكن التوصيل</button>
                        </div>
