        ...
        <header class="header header-fixed border-bottom onepage">
            <div class="header-content">
                ...
                <div class="mid-content">
                    <h4 class="title">تعديل المكان</h4>
                </div>
            ...
            <div class="container">
                <form action="{{ route('c1he3f.profile.store-delivery-address') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="city" name="city" value="{{ old('city') ?? $location->city }}" class="form-control" style="font-family: 'cairo'; text-align: center;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="location" name="area" value="{{ old('area') ?? $location->area }}" class="form-control" style="font-family: 'cairo'; text-align: center;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="delivery_fee" name="delivery_fee" value="{{ $location->delivery_fee }}" class="form-control" placeholder="الأسعار بالدرهم الإماراتي" style="font-family: 'cairo'; text-align: center;">
