...
`
									...
									display: flex !important;">
                                        ...
                                        <div class="dz-content" style="flex: 2;">
                                            <h6 class="title">
                                                ...
                                                <a href="{{ url()->previous() ?: route('home') }}"><i style="color:black;" class="fa-solid fa-arrow-up-right-from-square"></i>
                                                </a>
                                            </h6>
                                        </div>
                                    </div>
                ...
                font-size: 35px;" class="fa-solid fa-{{ Auth::user()->chefProfile && Auth::user()->chefProfile->contract_type !== null ? 'circle-check' : 'circle-xmark' }}">
                                ...
                                <div class="swiper-slide">
                                    <div class="dz-card list style-4" style="{{ Auth::user()->socialMedia()->exists() ? 'border-color: green !important;' : 'border-color: red !important;' }} display: flex !important;">
                                        <div class="" style="flex: 1;">
                                            <i style="{{ Auth::user()->socialMedia()->exists() ? 'color: green;' : 'color: red;' }} font-size: 35px;" 
                                                class="fa-solid fa-{{ Auth::user()->socialMedia()->exists() ? 'circle-check' : 'circle-xmark' }}"></i>


                                        </div>
                                        <div class="dz-content" style="flex: 2;">
                                            <h6 class="title">
                                                <a href="{{ route('social-media.index') }}">منصات التواصل</a>
                                                <a href="{{ url()->previous() ?: route('home') }}"><i style="color:black;" 
