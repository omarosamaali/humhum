    ...
    <div class="page-wrapper">
                ...
                <div class="dz-product-detail" style="direction: rtl; bottom: 120px;">
                    <div class="detail-content">
                        ...
                        <div style="display: flex; gap: 10px; font-size: 13px; align-items: center;" class="tags">
                            <img src="{{ $recipe->kitchen && $recipe->kitchen->image ? asset('storage/' . $recipe->kitchen->image) : 'https://via.placeholder.com/30' }}"
                                ...
                                alt="{{ $recipe->kitchen ? $recipe->kitchen->name_ar : 'غير محدد' }}">
                        ...
                        <div style="display: flex; gap: 10px; align-items: center;">
                            ...
                            <div
                                style="background-color: #e00000; color: white; padding: 5px; border-radius: 5px; width: fit-content; margin-top: 10px;">
                                {{ $recipe->mainCategories?->name_ar ?? 'غير مصنف' }}
                            </div>
                            {{-- @if ($recipe->sub_categories) This checks if it's not null --}}
                    ...
                    <div style="display: flex;">
                        <div class="dz-item-rating"
                            style="background-color: #e00000; font-size: 17px; overflow: hidden; line-height: unset; border: 2px solid #e00000;">
                            <img src="{{ asset('storage/' . Auth::user()->chefProfile->official_image) }}"
                        ...
                        <div class="dz-meta-items">
                            <div class="dz-price flex-1" style="justify-content: space-between; display: flex;">
                                <div class="price" style="flex-direction: column; align-items: center;">
                                    <div>
                                        <sub><i class="fa fa-users"
                                                style="font-size: 14px; margin-left: 5px;"></i></sub>{{ $recipe->servings }}
                                    </div>
                                ...
                                @if (!$recipe->is_free)
                                    <div class="price" style="flex-direction: column; align-items: center;">
                                        <div>
                                            <sub><i class="fa fa-coins"
                                                    style="font-size: 14px;"></i></sub>{{ $recipe->price }}
                                        ...
                                        <div
                                            style="width: fit-content; font-size: 12px; color: gray; border-radius: 5px;">
                                            السعر</div>
                                    </div>
                                @endif
                            </div>
        ...
        @if (Auth::check() && Auth::user()->id == $recipe->user_id)
            <div class="footer-fixed-btn bottom-0 bg-white">
                <a href="
                {{-- {{ route('c1he3f.recpies.edit', $recipe->id) }} --}}
                 "
