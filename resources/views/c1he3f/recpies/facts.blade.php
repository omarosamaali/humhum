    ...
    <div class="page-wrapper">
        ...
        <main class="page-content space-top p-b100" style="direction: rtl;">
            <div class="container">
                ...
                <form action="{{ route('c1he3f.recpies.update_nutritional_facts', $recipe->id) }}" method="POST">
                    @csrf
                    @method('PUT') {{-- Use PUT method for updating --}}

                    <div class="my-3">
                        <label class="form-label" style="display: flex; justify-content: center;">السعرات الحرارية</label>
                        <input type="number" name="calories" id="calories" style="text-align: center; color: #000000;"
                            placeholder="السعرات الحرارية: 1300 كالوري" class="form-control"
                    ...
                    <div class="my-3">
                        ...
                        <input type="number" name="fats" id="fats" style="text-align: center; color: #000000;"
                            placeholder="نسبة الدهون: 30 جرام" class="form-control"
                            value="{{ $recipe->fats ?? 0 }}">
                    </div>
                    <div class="my-3">
                        <label class="form-label" style="display: flex; justify-content: center;">
                        ...
                        <input type="number" name="carbs" id="carbs" style="text-align: center; color: #000000;"
                            placeholder="الكربوهيدرات: 80 جرام" class="form-control"
                    ...
                    <div class="my-3">
                        ...
                        <input type="number" name="protein" id="protein" style="text-align: center; color: #000000;"
                            placeholder="البروتين: 30 جرام" class="form-control"
