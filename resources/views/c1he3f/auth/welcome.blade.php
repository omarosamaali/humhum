                            ...
                            <form class="m-b30" method="POST" action="{{ route('c1he3f.auth.welcome.post') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-mini input-lg">
                                        <input id="email" class="form-control" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="أدخل بريدك الإلكتروني">
                                    </div>
                                    <div class="pt-2">
                                        @error('email')
                                ...
                                <div class="m-b30">
                                    ...
                                    <div class="input-group input-mini input-lg">
                                        <input class="form-control dz-password" id="password" type="password" name="password" required autocomplete="current-password" placeholder="أدخل كلمة المرور" />
