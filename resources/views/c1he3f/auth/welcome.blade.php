...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css" integrity="sha512-LCY/8p2NaW6Bsmo1g3+6j+EkH0dY1o+2C73AVM0DIA3A92vN0bFz5H6uX3bM6+0F5a1g=="
    ...
    <div class="page-wrapper">
        ...
        <div class="sidebar dz-floting-sidebar">
            ...
            <ul class="nav navbar-nav" style="direction: ltr;">
                <li>
                    <a class="nav-link" href="{{ route('c1he3f.auth.sign-in') }}">
                        <span class="dz-icon">
                ...
                <li>
                    <a class="nav-link" href="{{ route('c1he3f.auth.sign-in') }}"> <span class="dz-icon">
                ...
                <div class="container py-0">
                    <div class="dz-authentication-area">
                        ...
                        <div class="account-section">
                            <form class="m-b30" method="POST" action="{{ route('c1he3f.auth.welcome.post') }}">
                                @csrf
                                <div class="mb-4">
                                ...
                                <div class="m-b30">
                                    ...
                                    <div class="input-group input-mini input-lg">
                                        <input class="form-control dz-password" id="password" type="password" name="password" required autocomplete="current-password"
                            ...
                            <div class="text-center account-footer">
                                ...
                                <a href="{{ route('c1he3f.auth.sign-up') }}" class="btn btn-secondary btn-lg btn-thin rounded-xl w-100">إنشاء حساب</a>
                            </div>
                        </div>
                    </div>
                </div>
