...
<body class="bg-light">
    ...
    <div class="page-wrapper">
        ...
        <main class="page-content space-top p-b100" style="direction: rtl;">
            <div class="container">
                ...
                <form action="{{ route('c1he3f.messages.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class=" p-5"
                        style="background-color: #f1d1d1; height: 40vh; width: 80%; margin: auto; border-radius: 15px;">
                    ...
                    <div class="my-3">
                        <input type="text" name="title" id="title" style="text-align: center; color: #000000;"
                            placeholder="العنوان" class="form-control" required>
                    </div>
                    <div class="my-3">
                        <textarea name="content" id="content" style="height: 98px; text-align: center; color: #000000;"
                            placeholder="ماذا تريد ان تقول" class="form-control" required></textarea>
                    </div>
        ...
        <!-- Footer Fixed Button -->
        {{-- <div class="footer-fixed-btn bottom-0 bg-white">
			<a href="c1he3f.all-snap" class="btn btn-lg btn-thin btn-primary w-100 rounded-xl">
				إرسال</a>
		</div> --}}
        <!-- Footer Fixed Button -->
    </div>
