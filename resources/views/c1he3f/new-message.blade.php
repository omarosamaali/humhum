...
<main class="page-content space-top p-b100" style="direction: rtl;">
        <div class="container">
            ...
            @endif
            <form action="{{ route('c1he3f.messages.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="bg-secondary p-5" style="height: 40vh; width: 80%; margin: auto; border-radius: 15px;">
                    <div style="top: 20%;" class="text-center">
                        <div>
                            <img class="w-25 mx-auto" src="https://global-web-assets.cpcdn.com/assets/camera-f90eec676af2f051ccca0255d3874273a419172412e3a6d2884f963f6ec5a2c3.png">
                            <p class="text-white font-weight-bold mt-3">أضف الفيديو أو الصورة</p>
                            <p class="text-white">نحن هنا لخدمتكم</p>
                        </div>
                        <input type="file" name="file" id="fil-ttd" class="form-control mt-3">
                    </div>
                </div>
                <div class="my-3">
                    <input type="text" name="title" id="title" style="text-align: center; color: #000000;" placeholder="العنوان" class="form-control" required>
                </div>
                <div class="my-3">
                    <textarea name="content" id="content" style="height: 98px; text-align: center; color: #000000;" placeholder="ماذا تريد ان تقول" class="form-control" required></textarea>
                </div>
                <div class="footer-fixed-btn bottom-0 bg-white">
                    <button type="submit" class="btn btn-lg btn-primary w-100 rounded-xl">إرسال</button>
                </div>
            </form>
        </div>
    </main>
		...
		<!-- Footer Fixed Button -->
		{{-- <div class="footer-fixed-btn bottom-0 bg-white">
			<a href="allSnap.html" class="btn btn-lg btn-thin btn-primary w-100 rounded-xl">
				إرسال</a>
		</div> --}}
		<!-- Footer Fixed Button -->
	</div>
