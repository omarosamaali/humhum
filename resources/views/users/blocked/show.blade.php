...
<body>
		...
		<header class="header header-fixed" style="border-bottom: 1px solid #eee;">
			<div class="header-content">
				...
				<div class="mid-content">
					<h4 class="title">قائمة المحظورات</h4>
				</div>
				...
				<div class="search-box">
					...
					<div class="search-box">
						<div class="input-group input-radius input-rounded input-lg">
							<input type="search" id="searchBlockedRecipes" placeholder="ابحث في الوجبات المحظورة"
								class="form-control">
    ...
    if (!searchInput) return; // لو السيرش مش موجود، نوقف
    ...
    searchInput.addEventListener('input', function() {
        ...
        recipeCards.forEach(function(card) {
            ...
            // لو البحث موجود في العنوان أو المطبخ أو الأعضاء أو التصنيفات
        ...
        if (visibleCards.length === 0 && searchTerm !== '') {
            ...
            message.innerHTML = `
                ...
                <p class="text-muted">لم نجد أي وجبات محظورة تطابق بحثك عن "<strong>${searchTerm}</strong>"</p>
            `;
            
            // نضيف الرسالة بعد السيرش بوكس
            ...
            if (searchBox && searchBox.nextSibling) {
                searchBox.parentNode.insertBefore(message, searchBox.nextSibling);
						...
						style="text-align: center; display: flex; justify-content: center; color: #660099; margin-top: 5px;">اختر
						الوصفة اذا أردت التعديل او الحذف</span>
				</div>
				...
				<div class="dz-custom-swiper">
					...
					<div class="text-center py-5">
						...
						<h5 class="mt-3">لا توجد وجبات محظورة</h5>
						<p class="text-muted">لم تقم بحظر أي وجبات بعد</p>
										...
										<div>
											<div style="display: flex; gap: 10px; font-size: 13px; align-items: center;"
												...
												<img src="{{ asset('storage/' . $blockedItem['recipe']->kitchen->image) }}"
													...
													alt="">
												{{ $blockedItem['recipe']->kitchen->name_ar }}
											</div>
											...
											<div style="margin-left: 28px; color: #333; font-size: 14px;">
												...
												<span style="color: #999; font-size: 12px;">
													...
													$blockedItem['blocked_count'] > 1 ? 'أفراد' :
													'فرد' }})
												</span>
											</div>
										</div>
		...
		function deleteRecipe() {
			Swal.fire({
				...
				if (result.isConfirmed) {
					Swal.fire("تم إلغاء الحظر", "", "success");
