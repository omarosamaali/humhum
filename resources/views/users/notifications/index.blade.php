        ...
        <header class="header header-fixed border-bottom">
            <div class="header-content">
                <div class="left-content">
                    <a href="javascript:void(0);" style="background-color: unset !important;" class="back-btn">
                        <i class="feather icon-home" style="font-weight: normal; color: #660099;"></i>
                    </a>
                </div>
                <div class="mid-content">
                    <h4 class="title">({{ $notifications->count() }}) الإشعارات </h4>
                </div>
                        ...
                        <li class="list-items" data-id="{{ $notification->id }}" style="position: relative;">
                            <div class="media">
                                <div class="list-content" >
                                    <h5 class="title" style="">{{ $notification->message }}</h5>
