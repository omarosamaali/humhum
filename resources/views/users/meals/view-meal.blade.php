        ...
        <header class="header header-fixed">
            <div class="header-content">
                ...
                <div class="mid-content">
                    <h4 class="title">وجبة إفطار {{ $recipe->meal_date }} </h4>
                </div>
                <div class="left-content">
                    <a href="{{ route('users.welcome') }}" class="back-btn">
                            ...
                            <ul class="featured-list">
                                ...
                                <a href="{{ route('users.meals.show-meal', $recipe->recipe->id) }}"
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary" style="float: left;"
                                        onclick="event.preventDefault(); window.location='{{ route('users.meals.change-recipe', [$recipe->id, 'recipe']) }}'">
