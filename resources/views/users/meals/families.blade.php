...
<div style="padding-top: 100px; margin: 0px 20px;">
    ...
    <div class="family-members-container">
        ...
        <div class="family-member-card"
            style="display: flex; align-items: center; gap: 15px; padding: 15px; border: 1px solid #ddd; border-radius: 10px; margin-bottom: 15px; background: white;">
            <!-- الصورة -->
            <div class="member-image" style="flex-shrink: 0;">
                @if(!empty($member->image))
                <img src="{{ asset('storage/' . $member->image) }}" alt="{{ $member->name ?? 'عضو العائلة' }}"
                    style="width: 60px; height: 60px; border-radius: 50%; object-fit: cover;">
                @else
                <div
                    style="width: 60px; height: 60px; border-radius: 50%; background: var(--primary); display: flex; align-items: center; justify-content: center; color: white;">
    ...
    <div style="text-align: center; padding: 40px 20px;">
        <i class="fa-solid fa-users" style="font-size: 50px; color: #ccc; margin-bottom: 15px;"></i>
        <p style="color: #666; font-size: 16px;">لا يوجد أفراد في العائلة</p>
    </div>
    @endif
</div>
    </div>
