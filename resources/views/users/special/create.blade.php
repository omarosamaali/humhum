...
<body>
                                    ...
                                    <div class="member-card family-cook-card" style="direction: rtl;"
                                        ...
                                        <div class="d-flex align-items-center" style="gap: 15px;">
                                            ...
                                            <label for="family-cook-{{ $member->id }}"
                                                ...
                                                <small
                                                    class="text-muted">{{ $member->relationship ?? 'فرد من العائلة' }}</small>
                                            </label>
                                        </div>
                                    </div>
                                @endforeach
    ...
    <script>
        // 🔥 JavaScript نظيف بدون تضارب - استبدل كل الـ scripts بهذا الكود
