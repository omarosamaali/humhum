        ...
        <main class="page-content space-top p-b80">
            <div class="container">
                <div class="edit-profile">
                    ...
                    <form action="{{ route('users.cooks.update', $cook) }}" method="POST">
                        @csrf
                        {{-- @method('put') --}}
                        <div class="profile-image">
                            <div class="avatar-upload">
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="{{ $cook?->image ? 
                                                    'background-image: url(' . asset($cook->image) . ');' 
                                                    : 'background-image: url(assets/images/default.jpg);' }}"></div>
                                    <div class="change-btn">
                                        <a href="{{ route('users.cooks.chooseImage', $cook) }}" for="imageUpload">
                        ...
                        <div class="col-md-12" id="passwordSection">
                            ...
                            <div class="otp-group" style="display: flex; gap:11px;" id="otpGroup"
                                ...
                                <input inputmode="numeric" pattern="[0-9]*" maxlength="1" data-index="0"
                                    ...
                                    placeholder="" autocomplete="off" required value="{{ $cook->password[0] }}">
                                <input inputmode="numeric" pattern="[0-9]*" maxlength="1" data-index="1"
                                    ...
                                    placeholder="" autocomplete="off" required value="{{ $cook->password[1] }}">
                                <input inputmode="numeric" pattern="[0-9]*" maxlength="1" data-index="2"
                                    ...
                                    placeholder="" autocomplete="off" required value="{{ $cook->password[2] }}">
                                <input inputmode="numeric" pattern="[0-9]*" maxlength="1" data-index="3"
                                    ...
                                    placeholder="" autocomplete="off" required value="{{ $cook->password[3] }}">
                            </div>
                        </div>
