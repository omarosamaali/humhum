...
<button id="notificationBtn" class="relative bg-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-[#5e5e5e] hover:border-orange-400 transform hover:scale-105">
...
<div id="notificationModal" class="fixed inset-0 z-50 hidden items-center justify-center modal-overlay">
    <div class="mb-[60px] bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-hidden transform transition-all duration-300">
        ...
        <div class="overflow-y-auto max-h-[70vh]" id="notificationsContainer">
            ...
            <div class="notification-new p-6 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-start mb-2" style="flex-direction: column;">
                            <h3 class="font-bold text-gray-800 text-lg" style="text-transform: capitalize;">{{ $notification->chef->name }}</h3>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <span class="text-sm font-medium text-gray-600 mb-1 block">تقييم
                                    الشيف:</span>
                                <div class="flex items-center gap-1">
                                    @php
                                    $rating = $notification->rating ?? 0; // استخدم rate من قاعدة البيانات أو 0 إذا كان فارغ
                                    $fullStars = floor($rating); // النجوم المكتملة
                                    $halfStar = ($rating - $fullStars) >= 0.5 ? 1 : 0; // نصف نجمة
                                    $emptyStars = 5 - $fullStars - $halfStar; // النجوم الفارغة
                                    @endphp
                                    <div class="flex items-center gap-1">
