<header class="header header-fixed" style="border-block: 1px solid #ccc;">
    <div class="header-content">
        <div class="left-content">
            <a href="{{ $back }}" style="background-color: unset !important; font-size: 24px;">
        ...
        <div class="right-content d-flex align-items-center gap-4">
            <a href="{{ $route }}">
                <svg enable-background="new 0 0 461.75 461.75" height="24" viewBox="0 0 461.75 461.75" width="24"
