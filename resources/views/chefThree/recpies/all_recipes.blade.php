                                        ...
                                        <div class="dz-card list">
                                            <div class="dz-media">
                                                <a href="{{ route('c1he3f.recpies.showChefRecipes', $recipe->id) }}">
                                                    ...
                                                    <img style="max-height: 132px;" src="{{ asset('storage/' . $recipe->dish_image) }}" alt="{{ $recipe->title }}"> {{-- افترض أن عندك عمود image باسم المسار --}}
                                                </a>
                                            </div>
                                            ...
                                            <div class="dz-content">
                                                <div class="dz-head">
                                                    ...
                                                    <span class="" style="    padding-bottom: 4px;
    color: #777777;
    display: block;
                                        ...
                                        <div class="dz-card list">
                                            ...
                                            <div class="dz-content">
                                                <div class="dz-head">
                                                    ...
                                                    @forelse ($recipe->subCategories as $subCategory)
                                                    <span style="padding-bottom: 4px; color: #777777; display: block; font-size: 14px;">{{ $subCategory->name_ar }}</span>
                                                    @empty
                                                    <span class="text-muted">لا توجد</span>
                                                    @endforelse
                                                    <ul class="tag-list">
