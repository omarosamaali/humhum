            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description_ar" name="description_ar" rows="4" required>{{ old('description_ar', $terms->description_ar) }}</textarea>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="status" id="status" required>
                            <option value="1" {{ old('status', $terms->status) == '1' ? 'selected' : '' }}>فعال
                            </option>
                            <option value="0" {{ old('status', $terms->status) == '0' ? 'selected' : '' }}>غير
                                فعال</option>
                        </select>
                        @error('status')
                            <div class="text-black">{{ $message }}</div>
                ...
                @foreach ($targetLanguages as $code => $name)
                    <div class="col-md-12 mb-3 border rounded-lg p-2">
                        ...
                        <span class="text-right">
                            {{ old('title_' . $code, $terms->{'title_' . $code}) }}
                        </span>
                        <br>
                        <label for="description_{{ $code }}" class="form-label font-bold">{{ $name }}
                            (الوصف):</label>
                        <span class="text-right">
                            {{ old('description_' . $code, $terms->{'description_' . $code}) }}
                        </span>
                    </div>
                @endforeach
            </div>
