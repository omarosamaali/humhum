...
@section('page-title', 'إدارة العائلات')
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        @enderror
                        <img id="image_preview" src="#" alt="معاينة الصورة" class="family-preview"
            ...
            <tbody>
                @forelse($families ?? [] as $family)
                    <tr>
                        ...
                        <td>
                            <span class="badge {{ $family->status_badge_class }}">
                                {{ $family->status_text }}
                            </span>
                        </td>
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('admin.families.show', $family->id) }}" class="btn btn-info btn-sm"
                                    title="عرض">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.families.edit', $family->id) }}" class="btn btn-warning btn-sm"
                                    title="تعديل">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-4">
                            ...
                            <p class="text-muted mt-2">لا توجد بيانات عائلات</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    هل أنت متأكد من حذف هذه العائلة؟
                </div>
...
@push('scripts')
    <script>
        ...
        function confirmDelete(familyId) {
            ...
            deleteForm.action = `/admin/families/${familyId}`;
