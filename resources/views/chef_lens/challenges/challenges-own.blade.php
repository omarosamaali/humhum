...
<head>
    ...
    <head>
        ...
        <title>Ombe- Coffee Shop Mobile App Template (Bootstrap + PWA) |
            DexignZone</title>
...
<body class="bg-light">
    <div class="page-wrapper">
        ...
        <header class="header header-fixed border-bottom" style="background: black !important;">
            <div class="header-content">
                <div class="mid-content">
                    <h4 class="title" style="color: white !important;">تحدياتي</h4>
                </div>
                <div class="left-content">
                    <a href="{{ url()->previous() }}" class="back--btn">
                        <i class="fa-solid fa-angle-left" style="color: white !important;"></i>
                    </a>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <ul class="featured-list">
                            @foreach($challengeResponses as $response)
                            @php
                            $endDate = \Carbon\Carbon::parse($response->challenge->end_date);
