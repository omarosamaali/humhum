                ...
                <div class="dz-authentication-area">
                    ...
                    <div class="account-section">
                        <form class="m-b20" action="{{ route('chef_lens.register') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="m-b30" style="background-color: transparent;">
                        ...
                        <div class="text-center">
                            <p class="form-text">بالنقر على "سجّل"، فإنك توافق على
                                <a href="{{ url()->previous() ?: route('home') }}" class="link" style="color: black;">الشروط</a> و <a href="{{ url()->previous() ?: route('home') }}" class="link" style="color: black;">سياسة الخصوصية</a>
                            </p>
                        </div>
