                ...
                <div class="dz-authentication-area">
                    ...
                    <div class="account-section">
                        <form class="m-b30" action="{{ route('chef_lens.login.post') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label class="form-label" for="email" style="color:rgb(0, 0, 0);">البريد الالكتروني</label>
                                <div class="input-group input-mini input-lg">
                                    <input style="color: rgb(0, 0, 0);" type="email" id="email" name="email" class="form-control" value="{{ old('email') }}">
                                </div>
                                @error('email')
                            ...
                            <div class="m-b30">
                                <label class="form-label" for="password" style="color:rgb(0, 0, 0);">كلمة المرور</label>
                                <div class="input-group input-mini input-lg">
                                    <input style="color: rgb(0, 0, 0);" type="password" id="password" name="password" class="form-control dz-password">
                            ...
                            <p class="form-text" style="color:black;">
                                نسيت كلمة المرور ؟ <a href="{{ route('chef_lens.forgot-password') }}" class="link ms-2" style="color:#5a5c77;">إسترجاع كلمة المرور</a>
                            </p>

                        </form>
                        <div class="text-center account-footer">

                            <p style="color:black;">ليس لديك حساب ؟</p>
                            <a href="{{ route('chef_lens.sign-up') }}" style="color: rgb(255, 255, 255); background-color: #5a5c77;" class="custom-btn btn btn-secondary btn-lg btn-thin rounded-xl w-100">إنشاء
