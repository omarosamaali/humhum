            ...
            <div class="swiper swiper-chefs">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="chef">
                            <img alt="الشيف {{ $chef->user->name }}" style="height: 600px; width: 400px;"
                                src="{{ asset('storage/' . $chef->official_image) }}">
                            <div class="chef-text" style="flex-direction: column;">
                                <span style="display: block;">
                                    ...
                                    الدولة: {{ $countryName }}
                                    <img src="https://flagcdn.com/24x18/{{ $chef->country }}.png"
                                        alt="علم {{ $chef->country }}"
        ...
        <div class="container">
            ...
            <div class="swiper swiper-kitchens">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img style="height: 100px; width: 100%; object-fit: fill;"
                            src="{{ asset('storage/' . $kitchen->image) }}" alt="المطبخ {{ $kitchen->name_ar }}">
                        ...
                        <div class="slider-container">
                            <div class="slider">
                                <div class="bratlee-hamint item">
                                    <p>A good restaurant is like a vacation; it transports you, and it becomes a lot
                                        more than just about the food. All great deeds and all great thoughts</p>
                    ...
                    <div class="col-xl-8">
                        <div class="best-food-restaurants">
                            <form role="form" id="reservation-form" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <input type="email" name="email" style="text-align: right;"
                                    ...
                                    <div class="col-xl-12">
                                        <textarea type="text" class="form-control" name="message"
                                            style="border-radius: 10px; height: 150px; text-align: right;"
