@if ($paginator->hasPages())
    <nav role="navigation" style="" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="pl-2 text-sm text-gray-700 leading-5 dark:text-gray-400">
                    {!! __('Showing') !!}
