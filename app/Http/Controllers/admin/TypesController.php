...
use App\Models\Types; // تأكد أن هذا هو الموديل الصحيح لسياسة الضيافة
...
class TypesController extends Controller
{
    ...
    {
        $aboutUs = Types::findOrFail($about_u);
        $targetLanguages = $this->targetLanguages;
        return view('admin.types.show', compact('aboutUs', 'targetLanguages'));
    }
    ...
    {
        $types = Types::findOrFail($about_u);
        $targetLanguages = $this->targetLanguages;
        return view('admin.types.edit', compact('types', 'targetLanguages'));
    }
