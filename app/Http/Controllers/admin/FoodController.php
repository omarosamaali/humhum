...
class FoodController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.about-us.index', compact('aboutUs', 'terms', 'hosp', 'food'));
    }
    ...
    {
        $aboutUs = Food::findOrFail($about_u);
        $targetLanguages = $this->targetLanguages;
        return view('admin.food.show', compact('aboutUs', 'targetLanguages'));
    }
    ...
    {
        $food = Food::findOrFail($about_u);
        $targetLanguages = $this->targetLanguages;
        return view('admin.food.edit', compact('food', 'targetLanguages'));
    }
